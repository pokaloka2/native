   ...
   // }
    ...
    if (!empty($_GET["msg"]) && $_GET["msg"] =='ar') {
        ...
        <div
            ...
            role="alert"
        >
            <strong>Alert Heading</strong> you are already Rigisterd,please<a href="index.php"> login </a>!
        </div>
    ...
    <div class="form-floating">
      <input type="text" name="name" class="form-control" id="floatingInput" placeholder="zyad ahmed" autocomplete="of">
      <label for="floatingInput">name</label>
      <small style="color : red;"><?php if(isset($_SESSION["errors"]["name"])) echo $_SESSION["errors"]["name"]?></small>
    </div>
    <div class="form-floating">
      <input type="text" name="email" class="form-control" id="floatingInput" placeholder="name@exmple.com">
      <label for="floatingInput">Email address</label>
      <small style="color : red;"><?php if(isset($_SESSION["errors"]["email"])) echo $_SESSION["errors"]["email"]?></small>
    </div>
    <div class="form-floating">
      <input type="text" name="phone" class="form-control" id="floatingInput" placeholder="name@exmple.com">
